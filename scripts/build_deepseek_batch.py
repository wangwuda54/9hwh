...
- 不要写稳定不限户、包过、不封号、百分百稳定。
- 不要写内部渠道、绕过平台政策、规避审核、绕审、代规避、抗风控、黑科技。
- 不要写 Cloak、cloak、Telegram/TG 引流、具体报价、灰色资源、账号买卖。
- 不要写违法违规承诺。
- 不要编造案例、团队、办公室、联系方式。
- 内容适合长期官网，不要像灰色落地页。
- 写作口吻改成行业实操解释腔：像真实做过投放、开户、素材、落地页和审核沟通的人在解释问题。
- 不要写成政策说明、审查说明、合规报告、风险提示清单或模板文章。
- 短句优先，直接说结论，多写客户会问什么、投放前会踩什么坑、实际操作中通常怎么判断。
- 要讲清账户、素材、落地页、审核反馈、预算和转化路径之间的关系。
- 风险边界要保留，但写成业务判断，不要写成官方口号。
